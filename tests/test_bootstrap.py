...
class TestBootstrapEntityPages:
    ...
    def test_typeddict_attributes_keep_presence_semantics(self):
        content = bootstrap_cmd._generate_entity_md(
            {
                "name": "Record",
                "model_kind": "typeddict",
                "attributes": [
                    {"name": "required_key", "type": "str", "required": True},
                    {"name": "optional_key", "type": "int", "required": False},
                    {"name": "unknown_key", "type": "bool"},
                ],
            },
            "records.py",
            {},
        ...
        assert "| `required_key` | `str` | *required* | — |" in content
        assert "| `optional_key` | `int` | *optional* | — |" in content
        assert "| `unknown_key` | `bool` | *unknown* | — |" in content
