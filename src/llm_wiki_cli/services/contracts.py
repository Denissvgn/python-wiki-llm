...
CI_CHECK_V2_SCHEMA_VERSION = "llm-wiki-ci-check/v2"
CI_CHECK_V3_SCHEMA_VERSION = "llm-wiki-ci-check/v3"
PROGRESS_SCHEMA_VERSION = "llm-wiki-progress/v1"
KNOWLEDGE_REUSE_SCHEMA_VERSION = "llm-wiki-knowledge-reuse/v1"
DOCTOR_SCHEMA_VERSION = "llm-wiki-doctor/v1"
DOCTOR_V3_SCHEMA_VERSION = "llm-wiki-doctor/v3"
HEALTH_DETAILS_SCHEMA_VERSION = "llm-wiki-health-details/v1"
...
PROTOCOL_VERSIONS = (
    ...
    KNOWLEDGE_REUSE_SCHEMA_VERSION,
    DOCTOR_SCHEMA_VERSION,
    DOCTOR_V3_SCHEMA_VERSION,
    HEALTH_DETAILS_SCHEMA_VERSION,
...
EXTRACT_ADDITIVE_FIELDS = {
    ...
    "calls[].invocation",
    "functions[].exported",
    "classes[].methods[].exported",
    "classes[].methods[].source_file",
    "main_block_calls",
    "params[].kind",
    "api_contracts",
}
