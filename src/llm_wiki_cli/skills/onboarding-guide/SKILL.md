...
When a guide needs screenshots, terminal recordings, or other usage media,
finish the guide prose first and then run `usage-examples`; this skill only
creates the narrative guide surface.
