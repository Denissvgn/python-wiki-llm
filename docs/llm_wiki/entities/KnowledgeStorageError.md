...
flowchart LR
    ...
    n5["_fail (src/llm_wiki_cli/services/knowledge_storage.py)"]
    n6["_validate_selected_record (src/llm_wiki_cli/services/knowledge_storage.py)"]
    n7["canonical_bytes (src/llm_wiki_cli/services/knowledge_storage.py)"]
    n8["decode_bytes (src/llm_wiki_cli/services/knowledge_storage.py)"]
    n9["KnowledgeStoreReader.select (src/llm_wiki_cli/services/knowledge_storage.py)"]
    n10["parse_store_root (src/llm_wiki_cli/services/knowledge_storage.py)"]
    n11["capture_knowledge_slice (src/llm_wiki_cli/services/knowledge_storage_access.py)"]
    n12["_git (src/llm_wiki_cli/services/knowledge_storage_diagnostics.py)"]
    n13["inspect_git_range (src/llm_wiki_cli/services/knowledge_storage_diagnostics.py)"]
    n0 --> n1
    n2 --> n0
    n3 --> n0
    n4 --> n0
    ...
    click n7 "../modules/knowledge_storage.md"
    click n8 "../modules/knowledge_storage.md"
    click n9 "../modules/knowledge_storage.md"
    click n10 "../modules/knowledge_storage.md"
    click n11 "../modules/knowledge_storage_access.md"
    click n12 "../modules/knowledge_storage_diagnostics.md"
    click n13 "../modules/knowledge_storage_diagnostics.md"
```
...
| `parse_store_root` | call | [knowledge_storage](../modules/knowledge_storage.md) | 2 |
| `capture_knowledge_slice` | call | [knowledge_storage_access](../modules/knowledge_storage_access.md) | 16 |
| `_git` | call | [knowledge_storage_diagnostics](../modules/knowledge_storage_diagnostics.md) | 3 |
| `inspect_git_range` | call | [knowledge_storage_diagnostics](../modules/knowledge_storage_diagnostics.md) | 7 |
