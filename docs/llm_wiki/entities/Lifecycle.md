...
flowchart LR
    ...
    n4["_lifecycle_event_digest_payload (src/llm_wiki_cli/services/knowledge_governance.py)"]
    n5["_lifecycle_event_summary (src/llm_wiki_cli/services/knowledge_governance.py)"]
    n6["_ordered_lifecycle_events (src/llm_wiki_cli/services/knowledge_governance.py)"]
    n7["_parse_lifecycle_event (src/llm_wiki_cli/services/knowledge_governance.py)"]
    n8["_validate_concept_summary (src/llm_wiki_cli/services/knowledge_governance.py)"]
    n9["_validate_lifecycle_event_fields (src/llm_wiki_cli/services/knowledge_governance.py)"]
    n10["_validate_lifecycle_histories (src/llm_wiki_cli/services/knowledge_governance.py)"]
    n11["_validate_lifecycle_summary (src/llm_wiki_cli/services/knowledge_governance.py)"]
    n0 --> n1
    n0 --> n2
    n3 --> n0
    n4 --> n0
