...
**Location:** `src/llm_wiki_cli/commands/sync_cmd.py:1629`
**Kind:** Class
**Bases:** —
...
```mermaid
flowchart LR
    n0["_SyncEntryPointAnalysis (src/llm_wiki_cli/commands/sync_cmd.py)"]
    n1["_detect_sync_entry_points (src/llm_wiki_cli/commands/sync_cmd.py)"]
    n1 --> n0
