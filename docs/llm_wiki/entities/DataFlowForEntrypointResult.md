...
**Location:** `src/llm_wiki_cli/api_types.py:104`
**Kind:** Class
...
_Auto-generated from `DataFlowForEntrypointResult` in `src/llm_wiki_cli/api_types.py`._
...
```mermaid
flowchart LR
    n0["DataFlowForEntrypointResult (src/llm_wiki_cli/api_types.py)"]
...
|---|---:|---|
| [api_types](../modules/api_types.md) | 0 | `data_flow` |
