...
| `_open_windows_directory_guard` | call | [filesystem_guard](../modules/filesystem_guard.md) |
| `_open_windows_directory_guard` | call | [filesystem_guard](../modules/filesystem_guard.md) |
| `create_private_windows_directory` | call | [filesystem_guard](../modules/filesystem_guard.md) |
| `create_private_windows_directory` | call | [filesystem_guard](../modules/filesystem_guard.md) |
| `create_private_windows_directory` | call | [filesystem_guard](../modules/filesystem_guard.md) |
| `guard_windows_directory_chain` | call | [filesystem_guard](../modules/filesystem_guard.md) |
| `guard_windows_directory_chain` | call | [filesystem_guard](../modules/filesystem_guard.md) |
