...
```mermaid
flowchart LR
    n0["LlmWikiSettings (integrations/obsidian/llm-wiki/src/main.ts)"]
    n1["buildCommandArgs (integrations/obsidian/llm-wiki/src/main.ts)"]
    n1 --> n0
    click n0 "../modules/src_main.md"
    click n1 "../modules/src_main.md"
```
