...
**Location:** `src/llm_wiki_cli/services/bootstrap_runtime.py:4135`
**Kind:** Class
**Bases:** —
...
_Auto-generated from `_WorkflowResult` in `src/llm_wiki_cli/services/bootstrap_runtime.py`._
...
```mermaid
flowchart LR
    n0["_WorkflowResult (src/llm_wiki_cli/services/bootstrap_runtime.py)"]
    ...
    n4["_write_bootstrap_index (src/llm_wiki_cli/services/bootstrap_runtime.py)"]
    n5["_write_bootstrap_workflow_pages (src/llm_wiki_cli/services/bootstrap_runtime.py)"]
    n1 --> n0
    n2 --> n0
    n3 --> n0
    n4 --> n0
...
|---|---:|---|
| [bootstrap_runtime](../modules/bootstrap_runtime.md) | 0 | `created`, `entries` |
...
| `_write_bootstrap_workflow_pages` | call | [bootstrap_runtime](../modules/bootstrap_runtime.md) | 2 |
| `_write_bootstrap_workflow_pages` | type_reference | [bootstrap_runtime](../modules/bootstrap_runtime.md) | — |
