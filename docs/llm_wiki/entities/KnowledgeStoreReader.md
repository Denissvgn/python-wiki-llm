...
| `_check_budget` | `() -> None` | — | — |
| `statistics` | `() -> dict[str, Any]` | — | Statistics from the captured wire nodes; no second parse or audit. |
| `release_capture` | `() -> None` | — | Release decoder intermediates after their owner has retained physical bytes. |
...
flowchart LR
    ...
    click n4 "../modules/knowledge_storage_access.md"
...
|---|---:|---|
| [knowledge_storage](../modules/knowledge_storage.md) | 16 | — |
