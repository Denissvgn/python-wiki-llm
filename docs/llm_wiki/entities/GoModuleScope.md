...
flowchart LR
    ...
    n2["_inventory_go_scopes (src/llm_wiki_cli/services/imports.py)"]
    n3["_read_go_module_scopes (src/llm_wiki_cli/services/imports.py)"]
    n4["ModulePathResolver._go_scope_matches (src/llm_wiki_cli/services/imports.py)"]
    n5["ModulePathResolver._nearest_go_scope (src/llm_wiki_cli/services/imports.py)"]
    n1 --> n0
    n2 --> n0
    n3 --> n0
    n4 --> n0
...
| `_inventory_go_scopes` | call | [imports](../modules/imports.md) | 1 |
| `_inventory_go_scopes` | type_reference | [imports](../modules/imports.md) | — |
