...
**Location:** `src/llm_wiki_cli/services/knowledge_artifacts.py:120`
**Kind:** Class
**Bases:** —
...
flowchart LR
    ...
    n6["build_knowledge_commit_plan (src/llm_wiki_cli/services/knowledge_artifacts.py)"]
    n7["require_validated_artifacts (src/llm_wiki_cli/services/knowledge_artifacts.py)"]
    n8["validate_knowledge_artifacts (src/llm_wiki_cli/services/knowledge_artifacts.py)"]
    n9["validated_artifact_bytes (src/llm_wiki_cli/services/knowledge_artifacts.py)"]
    n10["src/llm_wiki_cli/services/knowledge_freshness.py"]
    n11["src/llm_wiki_cli/services/knowledge_generation.py"]
    n1 --> n0
    n2 --> n0
    n3 --> n0
    n4 --> n0
...
|---|---:|---|
| [knowledge_artifacts](../modules/knowledge_artifacts.md) | 0 | `_validation`, `evaluated_envelope_hash`, `governance_hash`, `knowledge`, `knowledge_index_hash`, `storage_objects`, `storage_statistics`, `surface_index_hash`, `surface_payload` |
