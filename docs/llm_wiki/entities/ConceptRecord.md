...
flowchart LR
    ...
    n3["structural_freshness_modeled (src/llm_wiki_cli/services/knowledge_freshness.py)"]
    n4["_add_supersession_edges (src/llm_wiki_cli/services/knowledge_governance.py)"]
    n5["current_review_evidence (src/llm_wiki_cli/services/knowledge_governance.py)"]
    n6["_concept_for_page (src/llm_wiki_cli/services/knowledge_index.py)"]
    ...
    n9["_concept_to_payload (src/llm_wiki_cli/services/knowledge_model.py)"]
    n10["_parse_concept (src/llm_wiki_cli/services/knowledge_model.py)"]
    n1 --> n0
    n2 --> n0
    n3 --> n0
    n4 --> n0
...
| `structural_freshness_modeled` | type_reference | [knowledge_freshness](../modules/knowledge_freshness.md) | — |
