...
**Location:** `src/llm_wiki_cli/commands/sync_cmd.py:1623`
**Kind:** Class
**Bases:** —
...
```mermaid
flowchart LR
    n0["_ExtractedSyncInventory (src/llm_wiki_cli/commands/sync_cmd.py)"]
    n1["_extract_current_inventory (src/llm_wiki_cli/commands/sync_cmd.py)"]
    n1 --> n0
