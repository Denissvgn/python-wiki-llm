...
**Location:** `src/llm_wiki_cli/api_types.py:204`
**Kind:** Class
...
_Auto-generated from `PagesForSymbolResult` in `src/llm_wiki_cli/api_types.py`._
...
```mermaid
flowchart LR
    n0["PagesForSymbolResult (src/llm_wiki_cli/api_types.py)"]
    n1["_BoundedQueryResult (src/llm_wiki_cli/api_types.py)"]
    n2["pages_for_symbol (src/llm_wiki_cli/api.py)"]
    n0 --> n1
    n2 --> n0
...
|---|---:|---|
| [api_types](../modules/api_types.md) | 0 | `pages`, `symbol` |
