# refresh_entity_relationship_sections

**Entry point:** `sync_cmd._refresh_entity_relationship_sections`
...
This workflow starts at `sync_cmd._refresh_entity_relationship_sections`. The generated sequence is a bounded static projection; runtime ordering, branching, and side effects require source-level confirmation.
