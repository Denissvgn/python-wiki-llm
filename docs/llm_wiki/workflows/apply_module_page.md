...
**Entry point:** `sync_cmd._apply_module_page`
...
This workflow starts at `sync_cmd._apply_module_page`. The generated sequence is a bounded static projection; runtime ordering, branching, and side effects require source-level confirmation.
