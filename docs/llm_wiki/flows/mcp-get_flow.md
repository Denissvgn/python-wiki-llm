...
sequenceDiagram
    ...
    participant p1 as service.get_flow
    p0-->>p1: service.get_flow
```
...
| From | To | Line | Call |
|---|---|---:|---|
| get_flow | service.get_flow | 1152 | `service.get_flow(flow_id)` |
...
|---|---|---|---:|
| unresolved_call | `get_flow` | `service.get_flow` | 1152 |
