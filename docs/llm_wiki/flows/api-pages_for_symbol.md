...
| From | To | Line | Call |
|---|---|---:|---|
| pages_for_symbol | _normalize_query_input | 1988 | `_normalize_query_input(...)` |
...
| pages_for_symbol | normalize_documentation_query_text | 1989 | `normalize_documentation_query_text(symbol, field='symbol')` |
