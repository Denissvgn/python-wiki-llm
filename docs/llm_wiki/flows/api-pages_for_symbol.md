...
| From | To | Line | Call |
|---|---|---:|---|
| pages_for_symbol | _normalize_query_input | 2006 | `_normalize_query_input(...)` |
...
| pages_for_symbol | normalize_documentation_query_text | 2007 | `normalize_documentation_query_text(symbol, field='symbol')` |
