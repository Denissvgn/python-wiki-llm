...
sequenceDiagram
    ...
    participant p20 as _query_service(…).pages_for_symbol
    ...
    p0-->>p20: _query_service(…).pages_for_symbol
...
| From | To | Line | Call |
|---|---|---:|---|
| pages_for_symbol | _normalize_query_input | 1998 | `_normalize_query_input(...)` |
...
| pages_for_symbol | normalize_documentation_query_text | 1999 | `normalize_documentation_query_text(symbol, field='symbol')` |
