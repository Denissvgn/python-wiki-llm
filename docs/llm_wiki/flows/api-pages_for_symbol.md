...
```mermaid
sequenceDiagram
    participant p0 as pages_for_symbol
...
| From | To | Line | Call |
|---|---|---:|---|
| pages_for_symbol | cast | 1054 | `cast(PagesForSymbolResult, _run_query(...))` |
| pages_for_symbol | _run_query | 1056 | `_run_query(...)` |
...
| pages_for_symbol | pages_for_symbol | 1057 | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection).pages_for_symbol(symbol)` |
| pages_for_symbol | _query_service | 1057 | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection)` |
...
|---|---|---|---:|
| external_call | `pages_for_symbol` | `cast` | 1054 |
| unresolved_call | `_run_query` | `callback` | 1314 |
| unresolved_call | `pages_for_symbol` | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection).pages_for_symbol` | 1057 |
