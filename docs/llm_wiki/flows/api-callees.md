...
| From | To | Line | Call |
|---|---|---:|---|
| callees | _normalize_query_input | 1773 | `_normalize_query_input(...)` |
...
| callees | normalize_documentation_query_text | 1774 | `normalize_documentation_query_text(symbol, field='symbol')` |
