...
| From | To | Line | Call |
|---|---|---:|---|
| callees | _normalize_query_input | 1934 | `_normalize_query_input(...)` |
...
| callees | normalize_documentation_query_text | 1935 | `normalize_documentation_query_text(symbol, field='symbol')` |
