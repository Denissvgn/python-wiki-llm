...
> Call sequence diagram shows 30 of 526 interactions; 496 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
| From | To | Line | Call |
|---|---|---:|---|
| list_concept_sections | _normalize_query_input | 2055 | `_normalize_query_input(...)` |
...
| list_concept_sections | normalize_concept_coordinate | 2056 | `normalize_concept_coordinate(locator_or_exact_route)` |
