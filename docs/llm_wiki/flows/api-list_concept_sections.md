...
| From | To | Line | Call |
|---|---|---:|---|
| list_concept_sections | _normalize_query_input | 1534 | `_normalize_query_input(...)` |
...
| list_concept_sections | normalize_concept_coordinate | 1535 | `normalize_concept_coordinate(locator_or_exact_route)` |
