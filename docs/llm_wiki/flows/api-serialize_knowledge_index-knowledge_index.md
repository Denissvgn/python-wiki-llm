...
sequenceDiagram
    ...
    p7->>p8: _emit_extensions
    p7->>p8: _emit_extensions
    p7->>p12: _component_to_payload
    p12-->>p13: list
    p12->>p8: _emit_extensions
    p7->>p12: _component_to_payload
    p7->>p12: _component_to_payload
    p7->>p8: _emit_extensions
    p6-->>p14: sorted
    p6-->>p14: sorted
    p6-->>p14: sorted
    p6->>p15: _concept_to_payload
    p15->>p11: _wire_enum
    p15->>p11: _wire_enum
    p15->>p16: _basis_to_payload
    p16->>p11: _wire_enum
    p16->>p8: _emit_extensions
    p15->>p8: _emit_extensions
```

> Call sequence diagram shows 30 of 1035 interactions; 1005 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
flowchart LR
    ...
    s9 -. "isinstance(extensions, FrozenDict)" .-> s10
...
| _serialize_payload | dumps | 302 | `json.dumps(payload, indent=2, sort_keys=True, ensure_ascii=False, allow_nan=False)` |
