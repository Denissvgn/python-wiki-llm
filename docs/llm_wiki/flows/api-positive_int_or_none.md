...
| From | To | Line | Call |
|---|---|---:|---|
| positive_int_or_none | isinstance | 916 | `isinstance(value, bool)` |
| positive_int_or_none | isinstance | 916 | `isinstance(value, int)` |
...
|---|---|---|---:|
| external_call | `positive_int_or_none` | `isinstance` | 916 |
