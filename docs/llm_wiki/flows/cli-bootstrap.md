...
> Call sequence diagram shows 30 of 4475 interactions; 4445 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
| From | To | Line | Call |
|---|---|---:|---|
| run | _bootstrap_run_options_from_args | 6332 | `_bootstrap_run_options_from_args(args)` |
| _bootstrap_run_options_from_args | Path (src/llm_wiki_cli/services…rap_run_options_from_args) | 4436 | `Path(args.wiki_dir)` |
| _bootstrap_run_options_from_args | validate_path | 4437 | `validate_path(str(...), '--wiki-dir')` |
...
| _bootstrap_run_options_from_args | str (src/llm_wiki_cli/services…rap_run_options_from_args) | 4437 | `str(wiki_dir)` |

### Boundary effects

| Kind | Target | Step | Line |
|---|---|---|---:|
| output | `print` | `run` | 6338 |
