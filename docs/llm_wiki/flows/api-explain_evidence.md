...
| From | To | Line | Call |
|---|---|---:|---|
| explain_evidence | cast | 1221 | `cast(EvidenceExplanationResult, _run_query(...))` |
| explain_evidence | _run_query | 1223 | `_run_query(...)` |
...
| explain_evidence | explain_evidence | 1224 | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection).explain_evidence(locator_or_exact_route)` |
| explain_evidence | _query_service | 1224 | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection)` |
...
|---|---|---|---:|
| external_call | `explain_evidence` | `cast` | 1221 |
| unresolved_call | `_run_query` | `callback` | 1314 |
| unresolved_call | `explain_evidence` | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection).explain_evidence` | 1224 |
