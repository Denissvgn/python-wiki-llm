...
| From | To | Line | Call |
|---|---|---:|---|
| explain_evidence | _normalize_query_input | 1692 | `_normalize_query_input(...)` |
...
| explain_evidence | normalize_concept_coordinate | 1693 | `normalize_concept_coordinate(locator_or_exact_route)` |
