...
> Call sequence diagram shows 30 of 617 interactions; 587 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
| From | To | Line | Call |
|---|---|---:|---|
| main | _build_parser | 2507 | `_build_parser(data not statically known)` |
...
|---|---|---|---:|
| output | `print` | `main` | 2513 |
| output | `print` | `main` | 2516 |
| output | `print` | `main` | 2519 |
| environment_read | `os.environ.get` | `main` | 2522 |
| output | `print` | `main` | 2524 |
| output | `print` | `main` | 2527 |
