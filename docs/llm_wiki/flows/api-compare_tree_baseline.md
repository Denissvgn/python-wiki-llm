...
```mermaid
sequenceDiagram
    participant p0 as compare_tree_baseline
...
> Call sequence diagram shows 30 of 321 interactions; 291 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
flowchart LR
    ...
    s1 -->|"capture_tree_baseline(root, display=baseline.root_display, excluded_directories=baseline.excluded_directories, max_files=max_files, max_file_bytes=max_file_byt…"| s2
