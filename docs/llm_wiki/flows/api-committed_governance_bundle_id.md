...
> Call sequence diagram shows 30 of 686 interactions; 656 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
| From | To | Line | Call |
|---|---|---:|---|
| committed_governance_bundle_id | _previous_committed_artifacts | 707 | `_previous_committed_artifacts(wiki_dir, manifest, committed_state=committed_state)` |
