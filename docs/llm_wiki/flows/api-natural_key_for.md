...
sequenceDiagram
    ...
    participant p6 as len (src/llm_wiki_cli/services…identity.py:_machine_text)
    participant p7 as value.strip (src/llm_wiki_cli/services…identity.py:_machine_text)
    participant p8 as any (src/llm_wiki_cli/services…identity.py:_machine_text)
    participant p9 as character.isspace (src/llm_wiki_cli/services…identity.py:_machine_text)
    participant p10 as unicodedata.normalize (src/llm_wiki_cli/services…identity.py:_machine_text)
    ...
    p3-->>p6: len (src/llm_wiki_cli/services…identity.py:_machine_text)
    p3->>p5: ConceptIdentityError
    p3-->>p7: value.strip (src/llm_wiki_cli/services…identity.py:_machine_text)
    p3-->>p8: any (src/llm_wiki_cli/services…identity.py:_machine_text)
    p3-->>p9: character.isspace (src/llm_wiki_cli/services…identity.py:_machine_text)
    p3->>p5: ConceptIdentityError
    p3-->>p10: unicodedata.normalize (src/llm_wiki_cli/services…identity.py:_machine_text)
    p3->>p5: ConceptIdentityError
    p3-->>p8: any (src/llm_wiki_cli/services…identity.py:_machine_text)
    p3-->>p11: unicodedata.category(…).startswith (src/llm_wiki_cli/services…identity.py:_machine_text)
    p3-->>p12: unicodedata.category (src/llm_wiki_cli/services…identity.py:_machine_text)
    p3->>p5: ConceptIdentityError
...
flowchart LR
    ...
    s7["7. len (src/llm_wiki_cli/services…identity.py:_machine_text)"]
    s8["8. ConceptIdentityError"]
    s9["9. value.strip (src/llm_wiki_cli/services…identity.py:_machine_text)"]
    ...
    s4 -. "len (src/llm_wiki_cli/services…identity.py:_machine_text)(value)" .-> s7
    s4 -->|"ConceptIdentityError(field, ...)"| s8
    s4 -. "value.strip (src/llm_wiki_cli/services…identity.py:_machine_text)(data not statically known)" .-> s9
    s4 -. "any (src/llm_wiki_cli/services…identity.py:_machine_text)(...)" .-> s10
...
| `character.isspace (src/llm_wiki_cli/services…identity.py:_machine_text)` | - | - | - | - |
| `ConceptIdentityError` | - | - | - | - |
