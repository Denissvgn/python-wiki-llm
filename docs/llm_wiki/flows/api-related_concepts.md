...
> Call sequence diagram shows 30 of 376 interactions; 346 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
| From | To | Line | Call |
|---|---|---:|---|
| related_concepts | _normalize_query_input | 1530 | `_normalize_query_input(...)` |
...
| related_concepts | normalize_concept_coordinate | 1531 | `normalize_concept_coordinate(locator_or_exact_route)` |
