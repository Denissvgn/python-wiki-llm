...
|---|---|---|---|---|
| `related_concepts` | `locator_or_exact_route: object`, `direction: str`, `kinds: Iterable[str] \| None`, `service: DocumentationGraphQueryService \| None`, `src_dir: str`, `wiki_dir: str`, `limit: int`, `allow_external_src: bool` | `RelatedConceptsResult` | - | `cast(...)` |
| `cast` | - | - | - | - |
...
| From | To | Line | Call |
|---|---|---:|---|
| related_concepts | cast | 1147 | `cast(RelatedConceptsResult, _run_query(...))` |
| related_concepts | _run_query | 1149 | `_run_query(...)` |
...
| related_concepts | related_concepts | 1150 | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection).related_concepts(locator_or_exact_route, direction=direction, kinds=kinds)` |
| related_concepts | _query_service | 1150 | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection)` |
...
|---|---|---|---:|
| external_call | `related_concepts` | `cast` | 1147 |
| unresolved_call | `_run_query` | `callback` | 1314 |
| unresolved_call | `related_concepts` | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection).related_concepts` | 1150 |
