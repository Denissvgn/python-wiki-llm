...
> Call sequence diagram shows 30 of 1580 interactions; 1550 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
| verify_calibration_run | lock | 3201 | `store.lock(data not statically known)` |
