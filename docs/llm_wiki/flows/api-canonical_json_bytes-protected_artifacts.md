...
| canonical_json_bytes | json.dumps | 135 | `json.dumps(payload, ensure_ascii=False, allow_nan=False, sort_keys=True, separators=(...))` |
...
|---|---|---|---:|
| external_call | `canonical_json_bytes` | `isinstance` | 130 |
