...
| _reject_machine_local_paths | set | 1713 | `set(data not statically known)` |
| _reject_machine_local_paths | walk | 1757 | `walk(value, field_name)` |
...
|---|---|---|---:|
| unresolved_call | `hash_component_configuration` | `isinstance` | 859 |
