...
> Call sequence diagram shows 30 of 500 interactions; 470 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
| From | To | Line | Call |
|---|---|---:|---|
| get_concept | _normalize_query_input | 1870 | `_normalize_query_input(...)` |
...
| get_concept | normalize_concept_coordinate | 1871 | `normalize_concept_coordinate(locator_or_exact_route)` |
