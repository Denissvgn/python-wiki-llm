...
| From | To | Line | Call |
|---|---|---:|---|
| get_concept | _normalize_query_input | 1500 | `_normalize_query_input(...)` |
...
| get_concept | normalize_concept_coordinate | 1501 | `normalize_concept_coordinate(locator_or_exact_route)` |
