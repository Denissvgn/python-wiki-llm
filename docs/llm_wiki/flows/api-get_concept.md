...
| From | To | Line | Call |
|---|---|---:|---|
| get_concept | _normalize_query_input | 2039 | `_normalize_query_input(...)` |
...
| get_concept | normalize_concept_coordinate | 2040 | `normalize_concept_coordinate(locator_or_exact_route)` |
