...
| hash_inventory | items | 768 | `inventory.items(data not statically known)` |
...
|---|---|---|---:|
| unresolved_call | `hash_inventory` | `isinstance` | 765 |
| unresolved_call | `hash_inventory` | `inventory.items` | 768 |
| unresolved_call | `hash_inventory` | `isinstance` | 769 |
