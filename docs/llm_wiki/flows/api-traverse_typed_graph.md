...
> Call sequence diagram shows 30 of 532 interactions; 502 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
| From | To | Line | Call |
|---|---|---:|---|
| traverse_typed_graph | _normalize_query_input | 1997 | `_normalize_query_input(...)` |
...
| traverse_typed_graph | normalize_concept_coordinate | 1998 | `normalize_concept_coordinate(locator_or_exact_route)` |
