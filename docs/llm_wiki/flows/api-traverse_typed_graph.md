...
| From | To | Line | Call |
|---|---|---:|---|
| traverse_typed_graph | _normalize_query_input | 2164 | `_normalize_query_input(...)` |
...
| traverse_typed_graph | normalize_concept_coordinate | 2165 | `normalize_concept_coordinate(locator_or_exact_route)` |
