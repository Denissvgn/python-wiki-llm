...
|---|---|---|---|---|
| `traverse_typed_graph` | `locator_or_exact_route: object`, `direction: str`, `kinds: Iterable[str] \| None`, `origins: Iterable[str] \| None`, `resolutions: Iterable[str] \| None`, `include_evidence: bool`, `service: DocumentationGraphQueryService \| None`, `src_dir: str` | `TypedGraphTraversalResult` | - | `cast(...)` |
| `cast` | - | - | - | - |
...
| From | To | Line | Call |
|---|---|---:|---|
| traverse_typed_graph | cast | 1185 | `cast(TypedGraphTraversalResult, _run_query(...))` |
| traverse_typed_graph | _run_query | 1187 | `_run_query(...)` |
...
| traverse_typed_graph | traverse_typed_graph | 1188 | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection).traverse_typed_graph(locator_or_exact_route, direction=direction, kinds=kinds, origins=origins, resolutions=resolutions, include_evidence=include_evidence)` |
| traverse_typed_graph | _query_service | 1188 | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection)` |
...
|---|---|---|---:|
| external_call | `traverse_typed_graph` | `cast` | 1185 |
| unresolved_call | `_run_query` | `callback` | 1314 |
| unresolved_call | `traverse_typed_graph` | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection).traverse_typed_graph` | 1188 |
