...
**Modules touched:** [api](../modules/api.md), [context_budget](../modules/context_budget.md), [context_packet](../modules/context_packet.md), [context_service](../modules/context_service.md), and 3 more
...
```mermaid
sequenceDiagram
    participant p0 as validate_context_packet (src/llm_wiki_cli/api.py)
    participant p1 as validate_context_packet (src/llm_wiki_cli/services/context_packet.py)
    ...
    p0->>p1: validate_context_packet (src/llm_wiki_cli/services/context_packet.py)
...
```mermaid
flowchart LR
    s1["1. validate_context_packet (src/llm_wiki_cli/api.py)"]
    s2["2. validate_context_packet (src/llm_wiki_cli/services/context_packet.py)"]
    ...
    s1 -->|"validate_context_packet (src/llm_wiki_cli/services/context_packet.py)(packet_bytes)"| s2
...
|---|---|---|---|---|
| `validate_context_packet (src/llm_wiki_cli/api.py)` | `packet_bytes: bytes \| bytearray \| memoryview` | `context_packet_service` | - | `validation` |
| `validate_context_packet (src/llm_wiki_cli/services/context_packet.py)` | `packet_bytes: bytes \| bytearray \| memoryview` | - | - | `ContextPacketValidation(...)` |
...
| From | To | Line | Call |
|---|---|---:|---|
| validate_context_packet (src/llm_wiki_cli/api.py) | validate_context_packet (src/llm_wiki_cli/services/context_packet.py) | 1490 | `context_packet_service.validate_context_packet(packet_bytes)` |
| validate_context_packet (src/llm_wiki_cli/services/context_packet.py) | _coerce_packet_bytes | 1676 | `_coerce_packet_bytes(packet_bytes)` |
| _coerce_packet_bytes | isinstance (src/llm_wiki_cli/services…t.py:_coerce_packet_bytes) | 2456 | `isinstance(value, bytes)` |
| _coerce_packet_bytes | isinstance (src/llm_wiki_cli/services…t.py:_coerce_packet_bytes) | 2458 | `isinstance(value, (...))` |
| _coerce_packet_bytes | bytes (src/llm_wiki_cli/services…t.py:_coerce_packet_bytes) | 2459 | `bytes(value)` |
| _coerce_packet_bytes | TypeError | 2461 | `TypeError('packet_bytes must be bytes-like')` |
| _coerce_packet_bytes | ContextPacketMalformedError | 2463 | `ContextPacketMalformedError('packet_bytes', 'must not be empty')` |
| _coerce_packet_bytes | len (src/llm_wiki_cli/services…t.py:_coerce_packet_bytes) | 2464 | `len(raw)` |
| _coerce_packet_bytes | ContextPacketMalformedError | 2465 | `ContextPacketMalformedError('packet_bytes', ...)` |
| _coerce_packet_bytes | raw.startswith | 2469 | `raw.startswith(b'\xef\xbb\xbf')` |
| _coerce_packet_bytes | ContextPacketMalformedError | 2470 | `ContextPacketMalformedError('packet_bytes', 'must not contain a UTF-8 byte-order mark')` |
...
|---|---|---|---:|
| external_call | `_coerce_packet_bytes` | `isinstance` | 2456 |
| external_call | `_coerce_packet_bytes` | `isinstance` | 2458 |
| external_call | `_coerce_packet_bytes` | `bytes` | 2459 |
| external_call | `_coerce_packet_bytes` | `TypeError` | 2461 |
| unresolved_call | `_coerce_packet_bytes` | `raw.startswith` | 2469 |
