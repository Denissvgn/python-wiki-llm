...
| From | To | Line | Call |
|---|---|---:|---|
| validate_context_packet | validate_context_packet | 1004 | `context_packet_service.validate_context_packet(packet_bytes)` |
| validate_context_packet | PathPolicyError | 1006 | `PathPolicyError(str(...))` |
| validate_context_packet | str | 1006 | `str(exc)` |
| validate_context_packet | InvalidRequestError | 1008 | `InvalidRequestError(str(...))` |
| validate_context_packet | str | 1008 | `str(exc)` |
...
|---|---|---|---:|
| external_call | `validate_context_packet` | `context_packet_service.validate_context_packet` | 1004 |
| unresolved_call | `validate_context_packet` | `PathPolicyError` | 1006 |
