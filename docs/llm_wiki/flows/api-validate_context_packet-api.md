...
| From | To | Line | Call |
|---|---|---:|---|
| validate_context_packet (src/llm_wiki_cli/api.py) | validate_context_packet (src/llm_wiki_cli/services/context_packet.py) | 1509 | `context_packet_service.validate_context_packet(packet_bytes)` |
