...
```mermaid
sequenceDiagram
    participant p0 as current_lifecycle
...
> Call sequence diagram shows 30 of 317 interactions; 287 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
| From | To | Line | Call |
|---|---|---:|---|
| current_lifecycle | validate_governance_ledger | 1224 | `validate_governance_ledger(ledger)` |
