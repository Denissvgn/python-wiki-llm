...
| From | To | Line | Call |
|---|---|---:|---|
| prepare_calibration_run | _call_calibration_controller | 2528 | `_call_calibration_controller('prepare_calibration_run', root, control_workspaces=control_workspaces, execution_manifest=execution_manifest)` |
| _call_calibration_controller | getattr | 2516 | `getattr(controller, name)` |
