...
flowchart LR
    ...
    s3["3. getattr"]
    s1 -->|"_call_calibration_controller('prepare_calibration_run', root, control_workspaces=control_workspaces, execution_manifest=execution_manifest)"| s2
...
|---|---|---|---|---|
| `prepare_calibration_run` | `root: str \| Path`, `control_workspaces: Sequence[str \| Path]`, `execution_manifest: Mapping[str, Any]` | - | - | `_call_calibration_controller(...)` |
...
| From | To | Line | Call |
|---|---|---:|---|
| prepare_calibration_run | _call_calibration_controller | 2883 | `_call_calibration_controller('prepare_calibration_run', root, control_workspaces=control_workspaces, execution_manifest=execution_manifest)` |
| _call_calibration_controller | getattr | 2871 | `getattr(controller, name)` |
...
|---|---|---|---:|
| external_call | `_call_calibration_controller` | `getattr` | 2871 |
