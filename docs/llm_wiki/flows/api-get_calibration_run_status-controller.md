...
> Call sequence diagram shows 30 of 1254 interactions; 1224 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
| get_calibration_run_status | lock | 659 | `store.lock(data not statically known)` |
