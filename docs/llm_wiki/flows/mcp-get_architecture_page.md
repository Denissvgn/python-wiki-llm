...
sequenceDiagram
    ...
    participant p1 as service.get_architecture_page
    p0-->>p1: service.get_architecture_page
```
...
flowchart LR
    ...
    s2["2. service.get_architecture_page"]
...
| `service.get_architecture_page` | - | - | - | - |

### Call data

| From | To | Line | Call |
|---|---|---:|---|
| get_architecture_page | service.get_architecture_page | 1178 | `service.get_architecture_page(page)` |
...
|---|---|---|---:|
| unresolved_call | `get_architecture_page` | `service.get_architecture_page` | 1178 |
