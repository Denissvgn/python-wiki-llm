...
> Call sequence diagram shows 30 of 1325 interactions; 1295 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
| From | To | Line | Call |
|---|---|---:|---|
| run | getattr (src/llm_wiki_cli/commands/init_cmd.py:run) | 94 | `getattr(args, 'wiki_dir', DEFAULT_WIKI_DIR)` |
