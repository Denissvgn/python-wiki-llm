...
sequenceDiagram
    ...
    participant p20 as _query_service(…).data_flow_for_entrypoint
    ...
    p0-->>p20: _query_service(…).data_flow_for_entrypoint
...
| From | To | Line | Call |
|---|---|---:|---|
| data_flow_for_entrypoint | _normalize_query_input | 1351 | `_normalize_query_input(...)` |
...
| data_flow_for_entrypoint | normalize_documentation_query_text | 1352 | `normalize_documentation_query_text(id_or_symbol, field='id_or_symbol')` |
