...
| From | To | Line | Call |
|---|---|---:|---|
| dependency_neighborhood | cast | 1025 | `cast(DependencyNeighborhoodResult, _run_query(...))` |
| dependency_neighborhood | _run_query | 1027 | `_run_query(...)` |
...
| dependency_neighborhood | dependency_neighborhood | 1028 | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection).dependency_neighborhood(path)` |
| dependency_neighborhood | _query_service | 1028 | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection)` |
...
|---|---|---|---:|
| external_call | `dependency_neighborhood` | `cast` | 1025 |
| unresolved_call | `_run_query` | `callback` | 1314 |
| unresolved_call | `dependency_neighborhood` | `_query_service(service, src_dir=src_dir, wiki_dir=wiki_dir, limit=limit, allow_external_src=allow_external_src, read_only=read_only, source_selection=source_selection).dependency_neighborhood` | 1028 |
