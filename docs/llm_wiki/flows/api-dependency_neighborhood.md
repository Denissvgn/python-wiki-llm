...
| From | To | Line | Call |
|---|---|---:|---|
| dependency_neighborhood | _normalize_query_input | 1994 | `_normalize_query_input(...)` |
...
| dependency_neighborhood | normalize_supplied_paths | 1994 | `normalize_supplied_paths((...))` |
