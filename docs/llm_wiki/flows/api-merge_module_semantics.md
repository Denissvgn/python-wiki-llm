...
| From | To | Line | Call |
|---|---|---:|---|
| merge_module_semantics | get | 1214 | `semantics.get('classes', {...})` |
| merge_module_semantics | get | 1215 | `semantics.get('functions', {...})` |
| merge_module_semantics | get | 1216 | `semantics.get('description')` |
