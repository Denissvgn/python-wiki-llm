...
| require_validated_artifacts | isinstance (src/llm_wiki_cli/services…quire_validated_artifacts) | 160 | `isinstance(value, ValidatedKnowledgeArtifacts)` |
| require_validated_artifacts | TypeError (src/llm_wiki_cli/services…quire_validated_artifacts) | 161 | `TypeError('expected validator-issued knowledge artifacts')` |
| require_validated_artifacts | isinstance (src/llm_wiki_cli/services…quire_validated_artifacts) | 164 | `isinstance(validation, _ArtifactValidation)` |
| require_validated_artifacts | TypeError (src/llm_wiki_cli/services…quire_validated_artifacts) | 176 | `TypeError('knowledge artifacts were not issued by the validator or were replaced')` |
...
| external_call | `require_validated_artifacts` | `isinstance` | 160 |
| external_call | `require_validated_artifacts` | `TypeError` | 161 |
| external_call | `require_validated_artifacts` | `isinstance` | 164 |
| external_call | `require_validated_artifacts` | `TypeError` | 176 |
