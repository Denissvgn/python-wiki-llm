...
| From | To | Line | Call |
|---|---|---:|---|
| doctor | build_doctor_report | 1585 | `build_doctor_report(wiki_dir, src_dir, strict=strict, allow_external_src=allow_external_src, source_selection=source_selection)` |
