...
> Call sequence diagram shows 30 of 328 interactions; 298 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
| From | To | Line | Call |
|---|---|---:|---|
| add_alias | validate_governance_ledger | 1207 | `validate_governance_ledger(ledger)` |
