...
| From | To | Line | Call |
|---|---|---:|---|
| build_context | _normalise_focus | 1159 | `_normalise_focus(focus)` |
| _normalise_focus | isinstance (src/llm_wiki_cli/api.py:_normalise_focus) | 2729 | `isinstance(focus, str)` |
| _normalise_focus | list (src/llm_wiki_cli/api.py:_normalise_focus) | 2735 | `list(focus)` |
| build_context | _normalize_optional_knowledge_mode | 1160 | `_normalize_optional_knowledge_mode(knowledge_mode)` |
...
| _normalize_optional_knowledge_mode | cast (src/llm_wiki_cli/api.py:_…e_optional_knowledge_mode) | 383 | `cast(KnowledgeMode, value)` |
| build_context | _validate_protocol_request | 1176 | `context_cmd._validate_protocol_request(request)` |
...
|---|---|---|---:|
| external_call | `_normalise_focus` | `isinstance` | 2729 |
