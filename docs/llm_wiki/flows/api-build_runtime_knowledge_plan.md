...
> Call sequence diagram shows 30 of 2334 interactions; 2304 omitted to keep the visualization within the 30-interaction and generated-diagram limits.
...
| From | To | Line | Call |
|---|---|---:|---|
| build_runtime_knowledge_plan | isinstance | 360 | `isinstance(inputs, RuntimeKnowledgeInputs)` |
| build_runtime_knowledge_plan | TypeError | 361 | `TypeError('inputs must be a RuntimeKnowledgeInputs')` |
| build_runtime_knowledge_plan | replace | 363 | `replace(inputs, committed_state=capture_committed_knowledge(...))` |
| build_runtime_knowledge_plan | capture_committed_knowledge | 365 | `capture_committed_knowledge(inputs.target_wiki_dir, inputs.previous_manifest)` |
...
|---|---|---|---:|
| unresolved_call | `build_runtime_knowledge_plan` | `isinstance` | 360 |
| unresolved_call | `build_runtime_knowledge_plan` | `TypeError` | 361 |
| external_call | `build_runtime_knowledge_plan` | `replace` | 363 |
