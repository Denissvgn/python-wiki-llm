...
sequenceDiagram
    ...
    participant p1 as service.get_module
    p0-->>p1: service.get_module
```
...
| From | To | Line | Call |
|---|---|---:|---|
| get_module | service.get_module | 1149 | `service.get_module(module_id_or_source_path)` |
...
|---|---|---|---:|
| unresolved_call | `get_module` | `service.get_module` | 1149 |
