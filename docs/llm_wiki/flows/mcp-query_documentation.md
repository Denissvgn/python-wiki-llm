...
flowchart LR
    ...
    s6["6. TextContent"]
    s7["7. json.dumps"]
    s1 -->|"_native_tool_call(service.query_documentation, request)"| s2
...
|---|---|---|---|---|
| `query_documentation` | `request: dict` | - | - | `_native_tool_call(...)` |
...
| From | To | Line | Call |
|---|---|---:|---|
| query_documentation | _native_tool_call | 1326 | `_native_tool_call(service.query_documentation, request)` |
