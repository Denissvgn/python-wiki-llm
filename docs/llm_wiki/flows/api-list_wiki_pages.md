...
| From | To | Line | Call |
|---|---|---:|---|
| list_wiki_pages | _validate_wiki_dir | 1398 | `_validate_wiki_dir(wiki_dir)` |
| _validate_wiki_dir | validate_path | 2739 | `validate_path(wiki_dir, '--wiki-dir')` |
...
| list_wiki_pages | _wiki_page_payload | 1400 | `_wiki_page_payload(page)` |
| list_wiki_pages | collect_wiki_pages | 1401 | `wiki_surface.collect_wiki_pages(wiki_root)` |
