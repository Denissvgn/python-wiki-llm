...
flowchart LR
    ...
    s6["6. TextContent"]
    s7["7. json.dumps"]
    s1 -->|"_native_tool_call(service.explain_evidence, locator_or_exact_route, limit=limit)"| s2
...
|---|---|---|---|---|
| `explain_evidence` | `locator_or_exact_route: str`, `limit: int` | - | - | `_native_tool_call(...)` |
