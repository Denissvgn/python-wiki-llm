...
| From | To | Line | Call |
|---|---|---:|---|
| explain_evidence | service.explain_evidence | 1253 | `service.explain_evidence(locator_or_exact_route, limit=limit)` |
...
|---|---|---|---:|
| unresolved_call | `explain_evidence` | `service.explain_evidence` | 1253 |
