...
flowchart LR
    ...
    s3["3. getattr"]
    s1 -->|"_call_calibration_controller('verify_calibration_run', root, advance=advance)"| s2
...
|---|---|---|---|---|
| `verify_calibration_run` | `root: str \| Path`, `advance: bool` | - | - | `_call_calibration_controller(...)` |
...
| From | To | Line | Call |
|---|---|---:|---|
| verify_calibration_run | _call_calibration_controller | 3171 | `_call_calibration_controller('verify_calibration_run', root, advance=advance)` |
