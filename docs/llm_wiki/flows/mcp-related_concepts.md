...
sequenceDiagram
    ...
    participant p1 as service.related_concepts
    p0-->>p1: service.related_concepts
```
...
| `service.related_concepts` | - | - | - | - |

### Call data

| From | To | Line | Call |
|---|---|---:|---|
| related_concepts | service.related_concepts | 1188 | `service.related_concepts(locator_or_exact_route, direction=direction, kinds=kinds, limit=limit)` |
...
|---|---|---|---:|
| unresolved_call | `related_concepts` | `service.related_concepts` | 1188 |
