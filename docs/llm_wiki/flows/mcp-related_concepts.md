...
flowchart LR
    ...
    s6["6. TextContent"]
    s7["7. json.dumps"]
    s1 -->|"_native_tool_call(service.related_concepts, locator_or_exact_route, direction=direction, kinds=kinds, limit=limit)"| s2
...
|---|---|---|---|---|
| `related_concepts` | `locator_or_exact_route: str`, `direction: str`, `kinds: list[str] \| None`, `limit: int` | - | - | `_native_tool_call(...)` |
...
| From | To | Line | Call |
|---|---|---:|---|
| related_concepts | _native_tool_call | 1244 | `_native_tool_call(service.related_concepts, locator_or_exact_route, direction=direction, kinds=kinds, limit=limit)` |
