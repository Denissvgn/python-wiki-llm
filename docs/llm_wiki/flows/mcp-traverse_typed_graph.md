...
| From | To | Line | Call |
|---|---|---:|---|
| traverse_typed_graph | _native_tool_call | 1375 | `_native_tool_call(service.traverse_typed_graph, locator_or_exact_route, direction=direction, kinds=kinds, origins=origins, resolutions=resolutions, include_evidence=include_evidence, limit=limit)` |
