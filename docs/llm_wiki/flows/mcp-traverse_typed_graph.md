...
| From | To | Line | Call |
|---|---|---:|---|
| traverse_typed_graph | service.traverse_typed_graph | 1218 | `service.traverse_typed_graph(locator_or_exact_route, direction=direction, kinds=kinds, origins=origins, resolutions=resolutions, include_evidence=include_evidence, limit=limit)` |
...
|---|---|---|---:|
| unresolved_call | `traverse_typed_graph` | `service.traverse_typed_graph` | 1218 |
