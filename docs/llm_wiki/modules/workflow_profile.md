...
flowchart LR
    ...
    n6["src/llm_wiki_cli/services/task_evidence.py"]
    n7["src/llm_wiki_cli/services/workflow_profile.py"]
    n0 --> n1
    n0 --> n4
    n0 --> n5
    n0 --> n7
    ...
    click n6 "../modules/task_evidence.md"
    click n7 "../modules/workflow_profile.md"
```
